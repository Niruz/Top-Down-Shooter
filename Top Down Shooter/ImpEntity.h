...
struct ImpEntity : public BaseEnemy
{
	StateMachine<ImpEntity>*  myStateMachine;
	StateMachine<ImpEntity>*  GetFSM()const { return myStateMachine; }
	ImpEntity(int id, const std::string& name, const glm::vec3& myStartPosition, const glm::vec3& patrolTo);
	~ImpEntity();
