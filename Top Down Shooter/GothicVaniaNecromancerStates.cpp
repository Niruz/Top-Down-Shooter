...
void NecromancerDie::Enter(NecromancerEntity* entity)
{
	...
	GameWorld->GetLevelFromName("Cemetary")->SpawnEntity("Enemy Hit Death Large", glm::vec3(entity->mPosition.x, entity->mPosition.y, entity->mPosition.z + 0.5f), glm::vec3(1.0f, 0.0f, 0.0f));
